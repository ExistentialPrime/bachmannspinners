...
export const ALLSHOPITEMS: CartItem[] = [
  ...
  { 
    id: 4,
    name: 'Hog Hunter - Halloween Combo', 
    description: 'A three-pack of Halloween-themed Hog Hunter spinners. Celebrate the season in style!',
    price: 15.00,
    image: 'spinner-halloween-combo.jpg',
  },
